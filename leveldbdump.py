...
class LevelDbDump(object):
    def __init__(self):
        ...
        try:
            ...
            print("wrong database path '" + self.dbpath + "' or missing access rights? put it to ./leveldb or set the path with '-d'. use '" + os.path.basename(__file__) + " --help' for more help!")
            exit(1)
